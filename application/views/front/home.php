...
<html lang="en">
    <head>
        ...
        <!--superslides css-->
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/frontend/css/superslides.css">
        <!--animate css-->
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/frontend/css/animate.css">
        <!--YouTubePopUp css-->
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/frontend/css/YouTubePopUp.css">
        <!--main css-->
    ...
    <body data-spy="scroll" data-target=".site-header" data-offset="50">
        ...
        <!--mixitup js-->
        <script src="<?php echo base_url(); ?>assets/frontend/js/mixitup.min.js"></script>
        <!--counterup js-->
        <script src="<?php echo base_url(); ?>assets/frontend/js/jquery.counterup.min.js"></script>
        <!--waypoint js-->
        <script src="<?php echo base_url(); ?>assets/frontend/js/waypoint.js"></script>
        <!--superslides js-->
        <script src="<?php echo base_url(); ?>assets/frontend/js/jquery.superslides.min.js"></script>
        <!--google map key-->
