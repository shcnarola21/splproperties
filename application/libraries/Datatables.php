  ...
  */
  class Datatables
  {
    ...
    */
    ...
    public function order_by($val,$order)
    {
      $this->ci->db->order_by($val,$order);
      return $this;
    }
    
    public function or_like($val,$order)
    {
      $this->ci->db->like($val,$order);
      return $this;
    }
    
    public function not_like($field,$var)
    {
      $this->ci->db->not_like($field,$var);
      return $this;
    }
    ...
    */
    public function join($table, $fk, $type = NULL)
    {
      $this->joins[] = array($table, $fk, $type);
        $this->ci->db->protect_identifiers($table, FALSE);
      $this->ci->db->join($table, $fk, $type);
      $this->ci->db->protect_identifiers($table,TRUE);
      return $this;
    }
    /**
    ...
    public function having($condition){         
      $this->ci->db->having($condition);
      return $this;
    }
    
    public function or_where($field,$condition){     
      $this->ci->db->or_where($field,$condition);
      return $this;
    }
    
    public function or_where_in($field,$condition){     
      $this->ci->db->or_where_in($field,$condition);
      return $this;
    }
    
    public function where_in($field,$condition){     
      $this->ci->db->where_in($field,$condition);
      return $this;
    }
